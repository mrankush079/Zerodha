...
//       <h3>System Logs</h3>
//       <p>This section will display system activity, login history, and trade logs.</p>
//     </div>
//   );
// };
...
// import { AccessTime, Person, BugReport } from "@mui/icons-material";
...
//     try {
//       await axios.put(
//         `${API_BASE}/admin/logs/${id}/archive`,
//         {},
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
