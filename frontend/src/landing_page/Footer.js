      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p>&copy;2024, Ankush choudhary. All rights reserved.</p>
          </div>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            ...
            write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please
          ...
          <p>
            ...
            Please write the Bank account number and sign the IPO application form to authorize
            your bank to make payment in case of allotment. In case of non allotment the funds
            will remain in your bank account. As a business we don't give stock tips, and have
            not authorized anyone to trade on behalf of others. If you find anyone claiming to
            be part of Zerodha and offering such services, please create a ticket here.
          </p>
        </div>
      </div>
    </footer>
